...
namespace CapaPresentacion
{
    public partial class frmVentas : Form
    {
        ...
        private void btnagregarproducto_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Debe de Seleccinar un producto", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            {
                MessageBox.Show("La Cantidad - No puede saer mayor al Stock", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        private void dgvdata_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            if (e.ColumnIndex == 5) //Recuerda el número de columnas en el datagrid view para poner la imagen de borrar fila
            {
                e.Paint(e.CellBounds, DataGridViewPaintParts.All);

                var w = Properties.Resources.delet.Width;
                var h = Properties.Resources.delet.Height;
                var x = e.CellBounds.Left + (e.CellBounds.Width - w) / 2;
                var y = e.CellBounds.Top + (e.CellBounds.Height - h) / 2;

                e.Graphics.DrawImage(Properties.Resources.delet, new Rectangle(x, y, w, h));
                e.Handled = true;
            }
        }
        ...
        private void btnregistrar_Click(object sender, EventArgs e)
        {
            if (txtdocumentocliente.Text == "")
            {
                ...
                MessageBox.Show("No existen docuemnto del cliente", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            if (txtnombrecliente.Text == "")
            {
                ...
                MessageBox.Show("No existen nombre del cliente", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            if (dgvdata.Rows.Count < 1)
            {
                ...
                MessageBox.Show("Debe de ingresar productos en la venta", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
